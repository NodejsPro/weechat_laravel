...
use App\Mongodb\LogReportTotalDate;

class LogReportTotalDateRepository extends BaseRepository
{
	public function __construct(LogReportTotalDate $logReportTotalDate)
	{
